  ...
  return (
    <section className="flex flex-col gap-(--gap-m) p-(--padding-s)">
      <h3 className={`font-(family-name:--font-family-main) text-[36px]/[32px] text-left text-(color:--color-dark) font-[200]`}>
        Your van is more than a vehicle. <span className="font-[400]">It’s freedom, adventure, and home</span> — all in one. We don’t just build campers.We build the start of something unforgettable.
      </h3>
