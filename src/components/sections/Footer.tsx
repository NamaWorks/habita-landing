    ...
    <>
      <footer className={`bg-[url(public/assets/raw/IMG/JPG/luke-porter-dVHLuOe1Nwk-unsplash.jpg)] w-screen h-[100svh] bg-cover bg-center min-h-screen flex flex-col justify-between px-(--padding-xs) pb-(--padding-xs)`}>
        <div className={`flex flex-col gap-(--gap-ml)`}>
          ...
          <div>
            <h2 className={`font-(family-name:--font-family-main) text-[48px]/[40px] text-left uppercase text-(color:--color-white) font-[300] opacity-0 md:w-[65%] md:text-[96px]/[90px] md:w-full`} ref={prefooterh2FirstRef}>
              More than a build
            </h2>
            <h2 className={`font-(family-name:--font-family-main) text-[48px]/[40px] text-right uppercase text-(color:--color-white) font-[300] opacity-0 md:w-[65%] md:text-[96px]/[90px] md:w-full`} ref={prefooterh2SecondRef}>
              It's your way of life
            </h2>
          </div>

          <p className={`flex-1 text-(--font-parr-size) text-(color:--color-white) md:w-[35%] md:self-center`}>
